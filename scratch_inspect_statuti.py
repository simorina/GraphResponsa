...
for i, card in enumerate(cards, 1):
    ...
    trovate = [p for p in raw_dir.iterdir() if p.is_dir() and (p / 'scheda.json').exists() and f"scheda{scheda_id}.html" in (p / 'scheda.json').read_text(encoding='utf-8', errors='ignore')]
